...
[Brackets] indicate matter deleted from existing law. *hb0871*
END OF PAGE 1
...
20 ENHANCED AUTOMATIC VOTER REGISTRATION SYSTEM ON OR BEFORE JANUARY 1,
21 2029.
...
26 THE STATEWIDE VOTER REGISTRATION LIST; OR
...
5 2–1257 of the State Government Article, to the Senate Committee on Education, Energy,
6 and the Environment and the House Committee on Ways and Means that describes:

7 1. the efforts of the automatic voter registration agency to
8 register voters in the preceding calendar year; and

9 2. the implementation of an automatic voter registration
10 system; and

11 (ii)] on or before [January 1, 2020, and] January 1 each [subsequent]
12 year, submit a report, in accordance with § 2–1257 of the State Government Article, to the
13 Senate Committee on Education, Energy, and the Environment and the House
14 GOVERNMENT, LABOR, AND ELECTIONS Committee [on Ways and Means] that
15 describes:

16 [1.] (I) the number of individuals who completed an
17 applicable transaction OR REAL ID TRANSACTION in the preceding calendar year at the
18 automatic voter registration agency and the number of those individuals who registered to
19 vote or updated a voter registration record; and

20 [2.] (II) any efforts the automatic voter registration agency
21 plans to make to improve the efficiency and effectiveness of the voter registration process
22 at the agency.

23 (2) The Department of Human Services shall consolidate and submit the
24 reports required under paragraph [(1)(i) and (ii)] (1) of this subsection as a single document
25 on behalf of all the local departments of social services.

26 3–303.

27 (a) Notification of a change of party affiliation or a change to or from a decline
28 may be made:

29 (1) by information provided on a voter registration application by the same
30 methods provided for registration under Subtitle 2 of this title;

31 (2) by written notice, signed by the voter and sent by mail or otherwise
32 delivered to the local board in the county where the voter’s current voter registration
33 address is located or to which the voter has moved;
END OF PAGE 10
...
1 (a) If a voter fails to respond to a confirmation notice under § 3–502(c) of this
2 subtitle, the voter’s name shall be placed into inactive status on the statewide voter
3 registration list.

4 (b) A voter shall be restored to active status on the statewide voter registration
5 list after:

6 (1) completing and signing any of the following election documents:

7 [(1)] (I) a voter registration application;

8 [(2)] (II) a petition governed by Title 6 of this article;

9 [(3)] (III) a certificate of candidacy;

10 [(4)] (IV) an absentee ballot application; or

11 [(5)] (V) a written affirmation of residence completed on election day to
12 entitle the voter to vote either at the election district or precinct for the voter’s current
13 residence or the voter’s previous residence, as determined by the State Board; OR

14 (2) COMPLETING A REAL ID TRANSACTION THAT RESULTS IN THE
15 TRANSMISSION OF VOTER REGISTRATION INFORMATION TO THE STATE BOARD
16 UNDER § 3–203(H)(3)(I) OF THIS TITLE.

17 (c) An inactive voter who fails to vote in an election in the period ending with the
18 second general election shall be removed from the statewide voter registration list.

19 (d) Registrants placed into inactive status may not be counted for official
20 administrative purposes including establishing precincts and reporting official statistics.

21 SECTION 2. AND BE IT FURTHER ENACTED, That each report submitted by the
22 Motor Vehicle Administration on or before January 1, 2029, under § 3–203(o) of the Election
23 Law Article, as enacted by Section 1 of this Act, is not required to include information on
24 the number of individuals who completed a REAL ID transaction in the immediately
